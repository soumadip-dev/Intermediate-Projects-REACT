      ...
      {isLoading ? (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-2xl text-gray-600 mt-2">#{pokemon.id.toString().padStart(3, '0')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 flex flex-col items-center">
              <div className="w-full max-w-md bg-white rounded-xl p-6 shadow-lg border-2 border-yellow-300">
                {pokemon.image ? (
                  <img
                    src={pokemon.image}
                    alt={pokemon.name}
                  ...
                  <div className="w-full h-64 flex items-center justify-center bg-gradient-to-br from-red-100 via-blue-100 to-yellow-100 text-gray-500 rounded-lg">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-12 w-12"
                      fill="none"
              ...
              <div className="w-full max-w-md mt-6 bg-white rounded-xl p-6 shadow-lg border-2 border-blue-300">
                ...
                <div className="flex justify-center gap-4">
                  {pokemon.types.map((type, index) => (
                    <span
                      key={index}
                      className="px-6 py-2 rounded-full bg-gradient-to-r from-red-400 to-yellow-400 text-white font-bold text-lg capitalize shadow-md"
                    >
                      {type.type.name}
                    </span>
                  ))}
